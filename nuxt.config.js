...
export default {
  ...
  head: {
    ...
    link: [
      ...
      { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Montserrat:wght@400;700&family=Open+Sans:wght@400;700&display=swap' }
    ]
  },
  ...
  fontawesome: {
    component: 'FaIcon',
    icons: {
      solid: ['faEnvelope','faMapMarkerAlt','faPhone', 'faBars', 'faTimes', 'faArrowRight', 'faChevronRight', 'faChevronUp'],
